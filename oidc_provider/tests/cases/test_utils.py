...
class CommonTest(TestCase):
    ...
    def test_get_user_sid(self):
        ...
        user1_original_sid = get_user_sid(user1)
        self.assertTrue(user1_original_sid)
        ...
        self.assertNotEqual(user1_original_sid, get_user_sid(user2))

        # change login date for user1
        user1.last_login = timezone.datetime(year=2020, month=1, day=1)

        self.assertNotEqual(user1_original_sid, get_user_sid(user1))
